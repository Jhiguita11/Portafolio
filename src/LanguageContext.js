...
export const translations = {
  en: {
    ...
    clients: {
      ...
      title: "Clients",
      subtitle: "Companies and organizations I've collaborated with through MIESGROUP, delivering interactive experiences and digital products.",
      list: [
        {
          name: "HERRAGRO",
          initials: "HG",
        ...
        {
          name: "Once Caldas F.C.",
          initials: "OC",
          accent: "#22c55e",
          sector: "Professional Sports",
          desc: "One of Colombia's most historic football clubs. Built a formal VR goalkeeper training simulator for Meta Quest 2 as a proposal for their technical staff.",
          projects: ["MiesFUT VR"],
          year: "2024",
        },
        {
          ...
          initials: "AK",
          accent: "#a855f7",
          sector: "Brand & Entertainment",
          desc: "Client brand campaign deployed directly on the Fortnite platform via UEFN — a branded adventure mini-game reaching millions of players globally.",
          projects: ["Akayu Fortnite"],
          year: "2022",
        },
      ],
    },
  ...
  es: {
    ...
    clients: {
      ...
      title: "Clientes",
      subtitle: "Empresas y organizaciones con las que he colaborado a través de MIESGROUP, entregando experiencias interactivas y productos digitales.",
      list: [
        {
          name: "HERRAGRO",
          initials: "HG",
          ...
          desc: "El fabricante de ferretería líder de Colombia. Entregamos un videojuego publicitario interactivo para PC que presenta su línea de productos en ferias y eventos de marca.",
          projects: ["Herragro Game"],
          year: "2023",
        },
        {
          ...
          desc: "Empresa constructora e inmobiliaria. Desarrollamos un recorrido VR arquitectónico del proyecto residencial CasaLago para Meta Quest y PC.",
          projects: ["CasaLago VR"],
          year: "2024",
        },
        {
          ...
          desc: "Uno de los clubes de fútbol más históricos de Colombia. Construimos un simulador VR de entrenamiento de porteros para Meta Quest 2 como propuesta formal para su cuerpo técnico.",
          projects: ["MiesFUT VR"],
          year: "2024",
        },
        {
          ...
          initials: "AK",
          accent: "#a855f7",
          sector: "Marca & Entretenimiento",
          desc: "Campaña de marca desplegada directamente en la plataforma Fortnite vía UEFN — un minijuego publicitario de aventura que alcanzó millones de jugadores globalmente.",
          projects: ["Akayu Fortnite"],
          year: "2022",
        },
      ],
