    ...
    clients: {
      ...
      list: [
        ...
        },
        {
          ...
          desc: "Home services company for which I developed MiHogar, a web application to improve their customer experience and digital service management.",
          projects: ["MiHogar"],
          year: "2024",
        },
        {
          ...
          desc: "Creative game studio for which I built a custom web platform to present their brand identity, team, and project portfolio.",
          projects: ["KumandayStudios Web"],
          year: "2025",
        },
        {
    ...
    clients: {
      ...
      list: [
        ...
        },
        {
          ...
          desc: "Empresa de servicios para el hogar para la que desarrollé MiHogar, una aplicación web orientada a mejorar la experiencia del cliente y la gestión digital de sus servicios.",
          projects: ["MiHogar"],
          year: "2024",
        },
        {
          ...
          desc: "Estudio creativo de videojuegos para el que construí una plataforma web personalizada para presentar su identidad de marca, equipo y portafolio de proyectos.",
          projects: ["KumandayStudios Web"],
          year: "2025",
        },
        {
